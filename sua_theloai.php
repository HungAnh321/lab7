        ...
        <form name="sua_theloai" method="POST">
            ...
            <table width="100%">
                <tr>
                    <td>Tên thể loại: </td>
                    <td>
                        <input type="text" name="ten_theloai" value="<?php echo $ten_theloai;
                ?>">
                    </td>
                </tr>
                <tr>
                    <td>Thứ tự: </td>
                    <td>
                        <input type="text" name="thu_tu" value="<?php echo $thu_tu; ?>">
                    </td>
                </tr>
                <tr>
                    <td>Ẩn/Hiện: </td>
                    <td>
                        <select name="an_hien">
                            ...
                            <option value="0" 
                            <?php 
                            echo ($an_hien==0)?'selected="selected"':''; 
                            ?>
                            >Ẩn</option> 
                            </select> </td> </tr> <tr> <td colspan="2">
                            <input type="submit" value="Cập nhật thể loại" name="submit">
                        </td> 
                        </tr> 
                        </table> 
                        </form> 
